                                ...
                                <div class="Store-Information">
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <div class="info-text">
                                                <p>My Company, 982 Tran Hung Dao, Dien Ban, Quang Nam </p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="info-lefticon">
                                        ...
                                        <li>
                                            ...
                                            <div class="info-text">
                                                <p>Email : <a href="mailto:phamnhuquan291999@gmail.com"><i
                                                            class="fa fa-angle-double-right"></i>
                                                        phamnhuquan291999@gmail.com</a></p>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="payment-method">
                                    <img class="img-responsive pull-right" src="<c:url value="resources/img/payment.png"/>"
                                         alt="payment-method" />
                                </div>
                                <!-- PAYMENT-METHOD END -->
                            </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="copy-right">
                    <address>Copyright © 2015 <a href="http://bootexperts.com/">BootExperts</a> All Rights Reserved
                    </address>
                </div>
