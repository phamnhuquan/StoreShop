...
public class RestFB {
    ...
    public static String FACEBOOK_APP_ID = "3285076994954555";
    public static String FACEBOOK_APP_SECRET = "e963290c8f99e7369e55e9e3bbecf289";
    public static String FACEBOOK_REDIRECT_URL = "http://localhost:8080/Spring_Project_Final/login-facebook";
    ...
    public UserDetails buildUser(com.restfb.types.User user) {
        ...
        authorities.add(new SimpleGrantedAuthority(AccountRole.ROLE_USER.toString().trim()));
